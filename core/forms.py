...
from .models import Customer, Product, DeliveryCompany, Order, Payment, FollowUp, CashTransaction, Expense, Task, Note, Attachment
...
class OrderForm(BaseArabicForm):
    class Meta:
        model=Order; fields=['customer','product','quantity','unit_price','discount','delivery_company','delivery_fee','status','priority','delivery_tracking_number','due_date','assigned_to','notes']
