# Generated manually - no seed data
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('box_type', models.CharField(choices=[('cash', 'نقدي'), ('cliq', 'كليك'), ('bank', 'بنك'), ('card', 'بطاقة/فيزا'), ('wallet', 'محفظة إلكترونية'), ('other', 'أخرى')], db_index=True, default='cash', max_length=30, verbose_name='نوع الصندوق')),
