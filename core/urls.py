...
path('calendar/',views.calendar_view,name='calendar'), path('reports/',views.reports,name='reports'), path('export/orders.csv',views.export_orders_csv,name='export_orders_csv'),
]
