...
class InventoryMovementAdmin(admin.ModelAdmin):
    list_display=('product','movement_type','quantity','order','date','reference','created_by'); list_filter=('movement_type','date','product'); search_fields=('product__name','product__sku','reference','notes','order__customer__name')
@admin.register(ReturnRecord)
class ReturnRecordAdmin(admin.ModelAdmin):
    list_display=('order','product','quantity','reason','refund_amount','returned_to_stock','date'); list_filter=('reason','returned_to_stock','date'); search_fields=('order__customer__name','product__name','notes')
