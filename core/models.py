...
class Order(TimeStampedModel):
    STATUS_CHOICES=[('new','جديد'),('confirmed','مؤكد'),('preparing','قيد التجهيز'),('with_delivery','مع التوصيل'),('delivered','تم التسليم'),('cancelled','ملغي'),('returned','راجع'),('waiting','بانتظار رد'),('closed','مغلق')]
...
class Payment(TimeStampedModel):
    METHOD_CHOICES=[('cash','نقدي'),('cliq','كليك'),('bank','تحويل بنكي'),('card','بطاقة'),('delivery','تحصيل من شركة التوصيل'),('other','أخرى')]
    ...
    def save(self,*args,**kwargs):
        super().save(*args,**kwargs); self.order.refresh_payment_status()
        if self.cashbox:
