...
## إضافات OrderFlow Pro
- تسجيل الأوردرات مع حالات متابعة إضافية: مرفوض، لم يتم الرد على الهاتف، مع التوصيل، تم التسليم، راجع.
- تحديد حالة الدفع وطريقة الدفع: نقدي، كليك، بنك، بطاقة، تحصيل من شركة التوصيل.
- كشف تفصيلي لشركة التوصيل حسب الفترة والشركة مع الإجمالي والمدفوع والمتبقي.
- مستودع كامل: جرد المواد، حركات إدخال/خروج/تسليم/مرتجع/تالف/تسوية.
- شاشة مرتجعات مرتبطة بالأوردر وتعيد الكمية للمستودع عند اختيار ذلك.
- تقارير حسب الفترة للمبيعات، الذمم، المرتجعات، الحالات، المدن، المنتجات ومصادر العملاء.
- بحث ذكي يشمل العملاء، الأوردرات، المنتجات، المتابعات، المهام وحركات المستودع.

### ملاحظات Render
الملف جاهز للرفع على Render. تم إضافة runtime.txt لتثبيت Python 3.11.9 وتجنب مشاكل بناء psycopg2 على Python 3.13.
